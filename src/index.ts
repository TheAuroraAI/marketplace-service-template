...
app.get('/health', (c) => c.json({
  ...
  endpoints: [
    ...
    '/api/tiktok/trending',
    '/api/tiktok/hashtag/:tag',
    '/api/tiktok/creator/:handle',
    '/api/tiktok/sound/:id',
  ],
}));
...
app.notFound((c) => c.json({ error: 'Not found', endpoints: ['/', '/health', '/api/run', '/api/details', '/api/jobs', '/api/reviews/search', '/api/reviews/:place_id', '/api/business/:place_id', '/api/reviews/summary/:place_id', '/api/tiktok/trending', '/api/tiktok/hashtag/:tag', '/api/tiktok/creator/:handle', '/api/tiktok/sound/:id'] }, 404));
